...
var _AdvanceSettings_instances,
	_AdvanceSettings_markup,
	_AdvanceSettings_analyticsUsage;
...
class AdvanceSettings extends Light {
	...
	modalPopUp(element) {
		...
		this.renderHTML(
			__classPrivateFieldGet(
				this,
				_AdvanceSettings_instances,
				"m",
				_AdvanceSettings_markup
			).call(this, componentData),
			"afterbegin",
			parentElement
		);
		__classPrivateFieldGet(
	...
	getSelectedSettings(componentName) {
		return __classPrivateFieldGet(
			...
			"m",
			_AdvanceSettings_markup
		).call(this, this.getSelectedComponent(componentName));
	}
...
(_AdvanceSettings_instances = new WeakSet()),
	(_AdvanceSettings_markup = function _AdvanceSettings_markup(component) {
	...
	(_AdvanceSettings_analyticsUsage = function _AdvanceSettings_analyticsUsage(
		data
	) {
